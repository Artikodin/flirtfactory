      ...
      <div>
        ...
        {path == "futur" && (
          <>
            <video
              style={{
                display: number === 2 && futur === 1 ? "block" : "none"
              }}
            ...
            <video
              style={{
                display: number === 2 && futur === 2 ? "block" : "none"
              }}
            ...
            <video
              style={{
                display: number === 2 && futur === 3 ? "block" : "none"
              }}
            ...
            <video
              style={{
                display: number === 2 && futur === 4 ? "block" : "none"
              }}
            ...
            <video
              style={{
                display: number === 3 && futur === 1 ? "block" : "none"
              }}
            ...
            <video
              style={{
                display: number === 3 && futur === 2 ? "block" : "none"
              }}
            ...
            <video
              style={{
                display: number === 3 && futur === 3 ? "block" : "none"
              }}
            ...
            <video
              style={{
                display: number === 3 && futur === 4 ? "block" : "none"
              }}
